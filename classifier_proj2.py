...
import os
os.getcwd()
df_desc = pd.read_csv('steam_with_description.csv', encoding='ISO-8859-1')
df_desc.head()
...
#model_path = "D:/EBAC MTECH/CNI/Day 2/Workshop 2/Scripts/lightning_logs/version_16/checkpoints/QTag-epoch=10-val_loss=1.06.ckpt"
